#include "ExampleWithOneRelationSIOBlock.h"
...
void ExampleWithOneRelationSIOBlock::read( sio::read_device &device,
         sio::version_type vers ) {


  auto* dataVec = static_cast<::ExampleWithOneRelationCollection*>(_col)->_getBuffer() ;
...
void ExampleWithOneRelationSIOBlock::write( sio::write_device &device ){
