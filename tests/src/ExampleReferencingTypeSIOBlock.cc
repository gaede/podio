#include "ExampleReferencingTypeSIOBlock.h"
...
void ExampleReferencingTypeSIOBlock::read( sio::read_device &device,
         sio::version_type vers ) {


  auto* dataVec = static_cast<::ExampleReferencingTypeCollection*>(_col)->_getBuffer() ;
...
void ExampleReferencingTypeSIOBlock::write( sio::write_device &device ){
