...
ConstExampleHit::ConstExampleHit(unsigned long long cellID, double x, double y,
                                 double z, double energy)
...
/// Access the  cellID
const unsigned long long &ConstExampleHit::cellID() const {
