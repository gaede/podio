...
ExampleHit::ExampleHit(unsigned long long cellID, double x, double y, double z,
                       double energy)
...
const unsigned long long &ExampleHit::cellID() const {
...
void ExampleHit::cellID(unsigned long long value) {
