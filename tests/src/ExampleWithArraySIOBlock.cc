#include "ExampleWithArraySIOBlock.h"
...
void ExampleWithArraySIOBlock::read( sio::read_device &device,
  ...
  auto* dataVec = static_cast<::ExampleWithArrayCollection*>(_col)->_getBuffer() ;
...
void ExampleWithArraySIOBlock::write( sio::write_device &device ){
