#include "ExampleClusterSIOBlock.h"
...
void ExampleClusterSIOBlock::read(sio::read_device &device,
                                  sio::version_type vers) {

  auto *dataVec = static_cast<::ExampleClusterCollection *>(_col)->_getBuffer();
...
void ExampleClusterSIOBlock::write(sio::write_device &device) {
