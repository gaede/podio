#include "ExampleWithARelationSIOBlock.h"
...
void ExampleWithARelationSIOBlock::read( sio::read_device &device,
         sio::version_type vers ) {


  auto* dataVec = static_cast<ex42::ExampleWithARelationCollection*>(_col)->_getBuffer() ;
...
void ExampleWithARelationSIOBlock::write( sio::write_device &device ){
