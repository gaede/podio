#include "ExampleWithComponentSIOBlock.h"
...
void ExampleWithComponentSIOBlock::read( sio::read_device &device,
         sio::version_type vers ) {


  auto* dataVec = static_cast<::ExampleWithComponentCollection*>(_col)->_getBuffer() ;
...
void ExampleWithComponentSIOBlock::write( sio::write_device &device ){
