...
void ExampleMCSIOBlock::read(sio::read_device &device, sio::version_type vers) {

  auto *dataVec = static_cast<::ExampleMCCollection *>(_col)->_getBuffer();
...
void ExampleMCSIOBlock::write(sio::write_device &device) {
